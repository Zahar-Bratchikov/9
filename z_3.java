...
public class z_3 {
    ...
    public static int a(Character[] arr) {
        int counta = 0;
    ...
    public static int b(Character[] arr, char s) {
        int countb = 0;
        for (Character character : arr) {
            if (character == s) {
                countb += 1;
    ...
    public static boolean c(Character[] arr, String inputNumber) {
        int count = 0;
        for (char ch : arr) {
    ...
    public static boolean f(Character[] arr) {
